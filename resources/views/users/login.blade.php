...
<section>
    <div class="card shadow">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="https://cdn.pixabay.com/photo/2019/01/06/20/23/non-woven-bags-3917805_960_720.jpg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <form>
                ...
                <p class="mb-5 pb-lg-2" style="color: #393f81;">Não tem uma conta? <a href="{{ route('users.add') }}"
